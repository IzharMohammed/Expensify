...
export function buildInsightsPrompt(input: AggregatedInsightInput) {
  return [
    ...
    'Allowed insight types are exactly: spending_pattern, comparison, suggestion.',
    'Do not invent new type names such as budget_pressure, alert, warning, or recommendation.',
    'If an insight is about budget pressure or overspending, encode it as type "suggestion" or "comparison".',
    'Rules:',
